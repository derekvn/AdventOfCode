...
dayone = "".join([ a[-1] if len(a) > 0 else '' for a in stack])
daytwo = "".join([ a[-1] if len(a) > 0 else '' for a in stack2])
print("Day one: %s" % dayone)
print("Day two: %s" % daytwo)
